/* Generado por herramientas/generar-respaldo.mjs — NO editar a mano.
   Copia de quienes-somos.json para cuando el sitio se abre con doble clic. */
  ...
  "integrantes": [
    {
      ...
      "rol": "Dirección y guion",
      "foto": "secciones/quienes-somos/fotos/paula.jpg",
      "descripcion": "Investiga y redacta los guiones de cada vídeo que registran hechos históricos de manera sencilla y lenguaje natural para el visitante. La cara bonita de los vídeos."
    },
    {
      "nombre": "Stiven León Pacheco",
      "rol": "Cámara y edición",
      "foto": "secciones/quienes-somos/fotos/stiven.jpg",
      "descripcion": "Se encarga de la fotografía, el sonido y el montaje final. Arma el color, los títulos y la música de cada video antes de publicarlo."
    }
  ]
};
